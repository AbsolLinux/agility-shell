...
```bash
curl -fsSL https://raw.githubusercontent.com/Naitik-Vadher-4661/agility-shell/main/install.sh | bash
```
>[!NOTE]
...
```bash
curl -fsSL https://raw.githubusercontent.com/Naitik-Vadher-4661/agility-shell/main/update.sh | bash
```
